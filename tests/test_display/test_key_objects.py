...
@pytest.mark.parametrize("pos, note_count, expected",
    # start_pos, notes, expected_pos, expected_list_index
     [(5, 10, (6, 5)),
      (9, 10, (10, 9)),
      # under 4 notes, don't loop
      (3, 3, (3, 2)),
      (10, 10, (1, 0))])
def test_scroll_down_movement_large_term(pos, note_count, expected):
    expected_pos, expected_list_index = expected
    mock_screen = MagicMock()
    mock_screen.getmaxyx.return_value = 20, 20
    test_scroll = key_objects.Scrollable(mock_screen, note_count)
    test_scroll.position = pos
    test_scroll.list_pointer = pos - 1
...
@pytest.mark.parametrize("note_count, test_with, expected",
    [(10, (3, 2, 0), (2, 1, 0)),
     (10, (1, 0, 0), (3, 9, 7)),
     # under 4 notes, don't loop
     (3, (1, 0, 0), (1, 0, 0)),
     ...
     (10, (2, 8, 7), (1, 7, 7)),
     (10, (0, 0, 0), (3, 9, 7))])
def test_scroll_up_movement_small_term(note_count, test_with, expected):
...
@pytest.mark.parametrize("note_count, test_with, expected",
    [(10, (1, 0, 0), (2, 1, 0)),
     ...
     (10, (2, 3, 2), (3, 4, 2)),
     (10, (3, 9, 7), (1, 0, 0))])
def test_scroll_down_movement_small_term(note_count, test_with, expected):
    pos, list_pos, list_top = test_with
...
@pytest.mark.parametrize("note_count, test_with, expected",
    [(10, (1, 0, 0), (1, 0, 0)),
     ...
     (10, (2, 3, 2), (1, 2, 2)),
     (10, (3, 9, 7), (1, 7, 7))])
def test_scroll_to_position_small_term(note_count, test_with, expected):
    pos, list_pos, list_top = test_with
    expected_pos, expected_list_pos, expected_list_top = expected
